...
\begin{remark}
有理数的英文为 Rational numbers, 其中 Rational 虽然有“理性的”的意思, 但是在这里的翻译并不准确, 实际上 ratio 有比率的意思, 而 Rational numbers 的含义应该为“比率数”.
\end{remark}
...
\ITEMS 
	...
	\item $\vdots$
\ITEME
    注意到上述 $a_n$ 中, 有无穷多个是 $1$.这样我们就建立了 $(0, 1]$ 和集合 $$S=\{(a_1,  a_2, \cdots,  a_n,  \cdots): \mbox{每个 $a_n$ 是 $0$ 或 $1$ 且 其中无穷多个 $a_n$ 是 $1$} \}$$ 的一一对应关系.\\
